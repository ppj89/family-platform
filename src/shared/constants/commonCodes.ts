...
export const FAMILY_MEMBER_OPTIONS = ['아빠', '엄마', '구성원'] as const

export const CALENDAR_CATEGORIES = ['일정', '그룹행사', '기념일', '병원', '학교', '여행', '기타'] as const
