...
const legacyOverridesCssPath = '/legacy-overrides.css?v=20260610-04'
const legacyPatchScriptPath = '/legacy-patch.js?v=20260610-04'
const legacyScriptPath = '/legacy/assets/index-DFjbaB-2.js?v=20260610-04'
