...
const legacyOverridesCssPath = '/legacy-overrides.css?v=20260612-15'
const legacyPatchScriptPath = '/legacy-patch.js?v=20260612-15'
const legacyScriptPath = '/legacy/assets/index-DFjbaB-2.js?v=20260612-15'
