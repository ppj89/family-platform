...
const legacyOverridesCssPath = '/legacy-overrides.css?v=20260610-02'
const legacyPatchScriptPath = '/legacy-patch.js?v=20260610-02'
const legacyScriptPath = '/legacy/assets/index-DFjbaB-2.js?v=20260610-02'
